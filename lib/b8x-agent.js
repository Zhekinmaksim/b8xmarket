  ...
  return send(res, 200, {
    ...
    metadata: {
      registry: {
        ...
        agentId: agent.id,
        wallet: agent.wallet,
        status: "registered_endpoint_verified_2026-09-09",
        verificationBlock: "129959947",
        ownerMatched: true,
        endpointStatus: 200,
        evidence: `${ORIGIN}/docs/evidence/submission-verification.json`,
      },
      fields: agent.fields,
      routes: agent.routes,
      ...
      activationEvidence:
        agent.slug === "b8xgrid"
          ? {
              ...
              status: "SUBMITTED",
              budgetU: "0",
              evidence: `${ORIGIN}/docs/ERC8183_JOB_1186.md`,
            }
          : null,
      paidHiring: false,
